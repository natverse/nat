...
#' skeletonised \emph{Drosophila} Kenyon cells as \code{dotprops} objects.
#' Original data is due to Chiang et al. 2011, who generously shared their raw
#' data (formerly at \code{flycircuit.tw}, no longer directly available but
#' still downloadable from virtual fly brain). Image registration and further
