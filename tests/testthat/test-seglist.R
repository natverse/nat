...
test_that("convert graph to seglist",{
  ...
  expect_no_warning(expect_equal(as.seglist(g), sl))
  ...
  g=igraph::make_graph(c(1,2,2,3,3,4,5,6))
  ...
  # trifurcation
  g=igraph::make_graph(c(1,2, 2,3, 2,4, 2,5, 5,6, 6,7))
  ...
  # rapid branching
  g=igraph::make_graph(c(1,2, 2,3, 2,4, 4,5, 4,6))
  ...
  g=igraph::make_graph(c(1,2, 2,6, 2,4, 4,5, 4,3))
