...
https://github.com/jefferis/nat/blob/master/vignettes/Installation.Rmd. 
...
[this link to edit](https://github.com/jefferis/nat/edit/master/vignettes/Installation.Rmd)
...
However, you can install any [release version](https://github.com/jefferis/nat/tags)
including the [latest release](https://github.com/jefferis/nat/releases/latest) 
as follows:
...
* Start a Cygwin terminal and go to the right directory with the command `cd \`.
