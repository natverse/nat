...
#'   package (see ?\link{cmtk} for installation details). The function 
#'   \code{\link{xform}} has methods to deal with a variety of types of 
#'   interest.
#'   
#' @section 3d image data: In addition to data types defined by unstructured 
#'   collections of 3d vertices such as neuron, dotprops and hxsurf objects nat 
#'   provides the \code{\link{im3d}} class to handle image/density data on a 
#'   regular grid. I/O is handled by \code{\link{read.im3d}} and 
#'   \code{\link{write.im3d}}, which are currently implemented for the amiramesh
#'   and nrrd file formats.
#'   
#' @section package options: The following options can be set to specify default
#'   behaviour. \itemize{ \item{\code{nat.cmtk.bindir}}{ Location of CMTK 
#'   binaries. See \code{\link{cmtk.bindir}}} 
