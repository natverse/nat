...
This is based on the commerically developed but open source 
...
You can set the figure size like so:
```{r}
nclear3d()
plot3d(Cell07PNs[1:3])
```
...
rgl is the default output for nat, so you do not need to choose it explictly
