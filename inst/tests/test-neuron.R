...
test_that("as.neuron.ngraph",{
  ...
  expect_equal(n$SubTrees,list(sl2,list(7)))
  ...
  expect_equal(n$SubTrees,list(sl3,list(1),list(8)))
  ...
  expect_equal(n$SegList,list(c(1,2,3)))
  n2=as.neuron(g,origin=3)
  expect_equal(n2$SegList,list(c(4,5,6,7)))
  n3=as.neuron(g,origin=7)
  expect_equal(n3$SegList,list(c(8,9,10,11,12)))
