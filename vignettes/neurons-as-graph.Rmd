...
* branch point
* end point
* continutation points

Each node will have a numeric identifier or label (an arbitrary integer stored the in the 
neuron's `PointNo` field which may have come froma an external source) as well
...
case. In the wild, one frequenlty encounters cases where e.g. the numeric labels
